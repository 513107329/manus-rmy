...
from app.domain.models.app_config import Mcp_Config, McpServerConfig, McpTransport
...
class McpClientManager:
    ...
    def __init__(self, mcp_config: Optional[Mcp_Config] = None) -> None:
        ...
        self._mcp_config: Mcp_Config = mcp_config  # mcp配置信息
    ...
    async def invoke(self, tool_name: str, arguments: Dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            if not original_server_name or not original_tool_name:
                raise NotFoundException(f"服务器解析MCP工具不存在: {tool_name}")
